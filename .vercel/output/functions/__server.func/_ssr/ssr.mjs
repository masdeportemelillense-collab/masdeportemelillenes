...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CBtdNyk-.mjs");
...
var manifest = { "7ef13e79095abd923abbf3e201d16e7e368a20b9d90fc541064e956cfc3fb71c": {
	functionName: "getLiveSnapshot_createServerFn_handler",
	importer: () => import("./get-snapshot-BpkmXeE8.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DqZBZICO.mjs").then((n) => n.t),
